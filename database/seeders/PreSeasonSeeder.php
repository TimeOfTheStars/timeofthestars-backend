...
//            ],
        ...
        $otherPlayer = [
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Каданцев Елисей')->first()->id,
                'number' => 8,
                'assists' => 0,
                'penalties' => 0,
                'goals' => 0,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Морозов Игорь')->first()->id,
                'number' => 75,
                'assists' => 0,
                'penalties' => 0,
                'goals' => 1,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Леонов Даниил')->first()->id,
                'number' => 2,
                'assists' => 0,
                'penalties' => 1,
                'goals' => 0,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Казакевич Евгений')->first()->id,
                'number' => 31,
                'assists' => 3,
                'penalties' => 0,
                'goals' => 2,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Лихачев Дмитрий')->first()->id,
                'number' => 41,
                'assists' => 1,
                'penalties' => 0,
                'goals' => 2,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Дмитриев Артем')->first()->id,
                'number' => 5,
                'assists' => 3,
                'penalties' => 1,
                'goals' => 1,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Макшеев Олег')->first()->id,
                'number' => 1,
                'assists' => 0,
                'penalties' => 1,
                'goals' => 1,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Евдокимов Вячеслав')->first()->id,
                'number' => 55,
                'assists' => 1,
                'penalties' => 0,
                'goals' => 0,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Олин Лев')->first()->id,
                'number' => 49,
                'assists' => 0,
                'penalties' => 2,
                'goals' => 0,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Казунин Дмитрий')->first()->id,
                'number' => 53,
                'assists' => 1,
                'penalties' => 0,
                'goals' => 0,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Герасимов Артем')->first()->id,
                'number' => 47,
                'assists' => 2,
                'penalties' => 1,
                'goals' => 2,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Цирулёв Никита')->first()->id,
                'number' => 77,
                'assists' => 1,
                'penalties' => 3,
                'goals' => 1,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Казаков Иван')->first()->id,
                'number' => 45,
                'assists' => 1,
                'penalties' => 1,
                'goals' => 0,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Идиатуллин Александр')->first()->id,
                'number' => 55,
                'assists' => 0,
                'penalties' => 0,
                'goals' => 0,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Козулин Дмитрий')->first()->id,
                'number' => 50,
                'assists' => 0,
                'penalties' => 0,
                'goals' => 0,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Макар Денис')->first()->id,
                'number' => 11,
                'assists' => 0,
                'penalties' => 0,
                'goals' => 0,
            ...
            [
                'tournament_id' => $predsezon,
                'team_id' => $bgv,
                'player_id' => Player::where('full_name', 'Анохин Артём')->first()->id,
                'number' => 30,
                'assists' => 0,
                'penalties' => 0,
                'goals' => 1,
