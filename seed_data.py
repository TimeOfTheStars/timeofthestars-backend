"""
Скрипт для заполнения базы данных моковыми данными
"""
import asyncio
...
async def seed_data():
    ...
    async with session_maker() as session:
        ...
        players_data = [
            # Команда 1 (Спартак)
            {"full_name": "Иванов Иван Иванович", "birth_date": date(1995, 5, 15), "position": "Нападающий", "grip": "Левый"},
            {"full_name": "Петров Петр Петрович", "birth_date": date(1996, 3, 20), "position": "Защитник", "grip": "Правый"},
            {"full_name": "Сидоров Сидор Сидорович", "birth_date": date(1997, 8, 10), "position": "Вратарь", "grip": "Левый"},
